...
#method to get data from a website and print and save it to a local file
...
#method to get a head messgae to check if the file has been edited
#if it hasnt print the file else send a get request
...
def main():
    ...
    while True:
        ...
        if n == 'b':
            ...
            counter = maxcount
            a.append(path)
        #check to see if the file is cached in the directory
        if checker:
